...
const labels = __webpack_require__(5)
...
"use strict";
const cnnutil = __webpack_require__(3);
const convnetjs = __webpack_require__(0);
  ...
  port.addEventListener("message", function (e) {
    try {
      if (e.data.type === "INITIALIZE") {
        // init network
        const importUtil = new __WEBPACK_IMPORTED_MODULE_1__import_util__["a" /* default */](e.data.params);
        this.network = new __WEBPACK_IMPORTED_MODULE_0__mnist_neural_network__["a" /* default */](post, importUtil, printCB, failCB);
        this.network.run();
